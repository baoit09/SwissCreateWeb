...
namespace SwissCreate.Services.Directory
{
    /// <summary>
    /// Currency service
    /// </summary>
    public partial class CurrencyService : ICurrencyService
    {
        ...
        /// {0} : currency ID
        /// </remarks>
        private const string CURRENCIES_BY_ID_KEY = "SwissCreate.currency.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CURRENCIES_ALL_KEY = "SwissCreate.currency.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CURRENCIES_PATTERN_KEY = "SwissCreate.currency.";
        ...
        public CurrencyService(ICacheManager cacheManager,
            ...
            ICompanyMappingService storeMappingService,
            CurrencySettings currencySettings,
            IEventPublisher eventPublisher)
        {
            this._cacheManager = cacheManager;
            this._currencyRepository = currencyRepository;
            this._companyMappingService = storeMappingService;
        ...
        public virtual decimal ConvertToPrimaryExchangeRateCurrency(decimal amount, Currency sourceCurrencyCode)
        {
            ...
            if (result != decimal.Zero && sourceCurrencyCode.Id != primaryExchangeRateCurrency.Id)
            {
                ...
                if (exchangeRate == decimal.Zero)
                    throw new SwissCreateException(string.Format("Exchange rate not found for currency [{0}]", sourceCurrencyCode.Name));
        ...
        public virtual decimal ConvertFromPrimaryExchangeRateCurrency(decimal amount, Currency targetCurrencyCode)
        {
            ...
            if (result != decimal.Zero && targetCurrencyCode.Id != primaryExchangeRateCurrency.Id)
            {
                ...
                if (exchangeRate == decimal.Zero)
                    throw new SwissCreateException(string.Format("Exchange rate not found for currency [{0}]", targetCurrencyCode.Name));
                result = result * exchangeRate;
            }
            return result;
        }
