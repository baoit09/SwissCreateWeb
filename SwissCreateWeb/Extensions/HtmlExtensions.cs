...
using SwissCreate.Services.Seo;
using SwissCreate.Services.Topics;
using SwissCreate.Web.Framework.UI.Paging;
using SwissCreate.Web.Infrastructure.Cache;
using SwissCreate.Web.Models.Boards;
using SwissCreate.Web.Models.Common;

namespace SwissCreate.Web.Extensions
{
    public static class HtmlExtensions
    {
        ...
        public static string GetTopicSeName<T>(this HtmlHelper<T> html, string systemName)
        {
            ...
            var cacheManager = EngineContext.Current.ContainerManager.Resolve<ICacheManager>("SwissCreate_cache_static");
