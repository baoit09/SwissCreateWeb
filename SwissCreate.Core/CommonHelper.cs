...
using System.Web;
using SwissCreate.Core.ComponentModel;
//using SwissCreate.Core.Domain.Shipping;
    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email) {
            ...
            if(!IsValidEmail(output)) {
                throw new SwissCreateException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new SwissCreateException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new SwissCreateException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
