...
namespace SwissCreate.Core.Infrastructure.DependencyManagement
{
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new SwissCreateException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (SwissCreateException)
                {

                }
            }
            throw new SwissCreateException("No contructor was found that had all the dependencies satisfied.");
        }
